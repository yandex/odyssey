...
static int
mm_clock_cmp(mm_timer_t *a, mm_timer_t *b)
{
...
void
mm_clock_init(mm_clock_t *clock)
{
...
void
mm_clock_free(mm_clock_t *clock)
{
...
static int
mm_clock_get_insert_position(mm_timer_t **list, int count, mm_timer_t *timer)
{
...
static int
mm_clock_list_is_sorted(mm_timer_t **list, int count)
{
...
int
mm_clock_timer_add(mm_clock_t *clock, mm_timer_t *timer)
{
	...
	memmove(list + insert_position + 1,
...
int
mm_clock_timer_del(mm_clock_t *clock, mm_timer_t *timer)
{
	if (!timer->active)
		return -1;
...
int
mm_clock_step(mm_clock_t *clock)
{
	if (clock->timers_count == 0)
		return 0;
	mm_timer_t **list;
...
void
mm_clock_update(mm_clock_t *clock)
{
