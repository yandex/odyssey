...
void
mm_machinemgr_init(mm_machinemgr_t *mgr)
{
...
void
mm_machinemgr_free(mm_machinemgr_t *mgr)
{
	pthread_spin_destroy(&mgr->lock);
}

int
mm_machinemgr_count(mm_machinemgr_t *mgr)
{
	int count;
...
void
mm_machinemgr_add(mm_machinemgr_t *mgr, mm_machine_t *machine)
{
	pthread_spin_lock(&mgr->lock);
	machine->id = mgr->seq++;
...
void
mm_machinemgr_delete(mm_machinemgr_t *mgr, mm_machine_t *machine)
{
	pthread_spin_lock(&mgr->lock);
