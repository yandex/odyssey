...
int
mm_loop_init(mm_loop_t *);
int
mm_loop_shutdown(mm_loop_t *);
int
mm_loop_step(mm_loop_t *);
...
static inline int
mm_loop_read(mm_loop_t *loop, mm_fd_t *fd, mm_fd_callback_t on_read, void *arg)
{
...
static inline int
mm_loop_read_write(mm_loop_t *loop,
                   mm_fd_t *fd,
                   mm_fd_callback_t on_event,
                   void *arg)
{
...
static inline int
mm_loop_read_write_stop(mm_loop_t *loop, mm_fd_t *fd)
{
