...
static inline void
kiwi_param_free(kiwi_param_t *param)
{
	free(param);
}
...
static inline int
kiwi_param_compare_name(kiwi_param_t *param, char *name, int name_len)
{
	int rc;
...
static inline int
kiwi_param_compare(kiwi_param_t *a, kiwi_param_t *b)
{
	return kiwi_param_compare_name(a, kiwi_param_name(b), b->name_len);
}

static inline void
kiwi_params_init(kiwi_params_t *params)
{
	params->list  = NULL;
	params->count = 0;
}
...
static inline void
kiwi_params_free(kiwi_params_t *params)
{
...
static inline void
kiwi_params_add(kiwi_params_t *params, kiwi_param_t *param)
{
...
static inline int
kiwi_params_copy(kiwi_params_t *dest, kiwi_params_t *src)
{
...
static inline void
kiwi_params_replace(kiwi_params_t *params, kiwi_param_t *new_param)
{
	kiwi_param_t *param = params->list;
