...
macro(build_shapito)
	set(SHAPITO_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/third_party/shapito)
	...
	add_custom_target(libshapito ALL
		DEPENDS ${PROJECT_BINARY_DIR}/third_party/shapito/shapito/libshapito${CMAKE_STATIC_LIBRARY_SUFFIX}
	)
	message(STATUS "Use shipped libshapito: ${PROJECT_SOURCE_DIR}/third_party/shapito")
	set (SHAPITO_LIBRARIES "${PROJECT_BINARY_DIR}/third_party/shapito/shapito/libshapito${CMAKE_STATIC_LIBRARY_SUFFIX}")
	set (SHAPITO_FOUND 1)
