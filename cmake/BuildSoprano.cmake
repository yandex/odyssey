...
macro(build_soprano)
	...
	if (${PROJECT_BINARY_DIR} STREQUAL ${PROJECT_SOURCE_DIR})
		add_custom_command(
			OUTPUT  ${PROJECT_BINARY_DIR}/lib/soprano/src/libsoprano${CMAKE_SHARED_LIBRARY_SUFFIX}
	...
	add_custom_target(libsoprano ALL
		DEPENDS ${PROJECT_BINARY_DIR}/lib/soprano/src/libsoprano${CMAKE_SHARED_LIBRARY_SUFFIX}
	)
	message(STATUS "Use shipped libsoprano: ${PROJECT_SOURCE_DIR}/lib/soprano")
	set (SOPRANO_LIBRARIES "${PROJECT_BINARY_DIR}/lib/soprano/src/libsoprano${CMAKE_SHARED_LIBRARY_SUFFIX}")
	set (SOPRANO_FOUND 1)
