...
print("=== Odyssey DEALLOCATE PREPARE name Test ===")
...
try:
    with psycopg.connect(conninfo, autocommit=True) as conn:
        ...
        # DEALLOCATE PREPARE only stmt1 (with PREPARE keyword)
        print("Sending DEALLOCATE PREPARE stmt1...")
        conn.execute("DEALLOCATE PREPARE stmt1")
