...
apply_fmt:
	clang-format ./third_party/machinarium/sources/*.c -i && clang-format ./third_party/machinarium/sources/*.h -i
	clang-format ./third_party/kiwi/kiwi/*.c -i && clang-format ./third_party/kiwi/kiwi/*.h -i
	clang-format ./sources/*.c -i && clang-format ./sources/*.h -i
